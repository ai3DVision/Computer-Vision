...
image1 = mpimg.imread(main_path + '/data/motorcycle.bmp')
image2 = mpimg.imread(main_path + '/data/bicycle.bmp')
...
plt.figure(3)
plt.imshow(vis)
plt.imsave(main_path+'/results/motor_bicycle/low_frequencies.png', low_frequencies, 'quality', 95)
plt.imsave(main_path+'/results/motor_bicycle/high_frequencies.png', high_frequencies + 0.5, 'quality', 95)
plt.imsave(main_path+'/results/motor_bicycle/hybrid_image.png', hybrid_image, 'quality', 95)
plt.imsave(main_path+'/results/motor_bicycle/hybrid_image_scales.png', vis, 'quality', 95)
plt.show()
