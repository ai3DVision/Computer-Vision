...
plt.imsave(main_path+'/results/test_filter_result/blur_image.png', normalize(blur_image + 0.5), 'quality', 95);
...
plt.imsave(main_path+'/results/test_filter_result/large_blur_image.png', normalize(large_blur_image + 0.5), 'quality', 95);
...
plt.imsave(main_path+'/results/test_filter_result/sobel_image.png', normalize(sobel_image + 0.5), 'quality', 95);
...
plt.imsave(main_path+'/results/test_filter_result/laplacian_image.png', normalize(laplacian_image + 0.5), 'quality', 95);
...
plt.imsave(main_path+'/results/test_filter_result/high_pass_image.png', normalize(high_pass_image + 0.5), 'quality', 95);
plt.show()
